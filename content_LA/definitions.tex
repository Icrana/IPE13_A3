...
\begin{description}
	...
	\item[Window function] is a (e.g. rectangular) function used as a window for calculating a DFT. When a function is multiplied by a window function, the product is zero-valued outside of the window's interval; all that is left ist the part where they overlap, the "view though the window" \figref{fig:window}.
		\begin{figure}[!h]
			\centering
